...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { begin_date: @promotion.begin_date, description: @promotion.description, end_date: @promotion.end_date, status: @promotion.status }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { begin_date: @promotion.begin_date, description: @promotion.description, end_date: @promotion.end_date, status: @promotion.status }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
